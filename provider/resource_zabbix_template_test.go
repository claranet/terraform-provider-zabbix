		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "trigger.3192477590.description", "trigger_name_A"),
					resource.TestCheckResourceAttr(resourceName, "trigger.3192477590.expression", "{template_test:key1.last()}=0"),
					resource.TestCheckResourceAttr(resourceName, "trigger.3192477590.priority", "5"),
					resource.TestCheckResourceAttr(resourceName, "trigger.3192477590.status", "0"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "trigger.1604588631.description", "trigger_name_A"),
					resource.TestCheckResourceAttr(resourceName, "trigger.1604588631.expression", "{template_test:key1.last()}=3"),
					resource.TestCheckResourceAttr(resourceName, "trigger.1604588631.priority", "4"),
					resource.TestCheckResourceAttr(resourceName, "trigger.1604588631.status", "1"),
					resource.TestCheckResourceAttr(resourceName, "trigger.1101767588.description", "trigger_name_2"),
					resource.TestCheckResourceAttr(resourceName, "trigger.1101767588.expression", "{template_test:key1.last()}=1"),
					resource.TestCheckResourceAttr(resourceName, "trigger.1101767588.priority", "2"),
					resource.TestCheckResourceAttr(resourceName, "trigger.1101767588.status", "0"),
